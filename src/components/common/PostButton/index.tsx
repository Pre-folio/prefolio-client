...
const Wrapper = styled.button<PostButtonProps>`
  ...
  background-color: ${(props) =>
    props.isClicked ? theme.palette.Mint30 : theme.palette.White};
  box-shadow: ${(props) =>
    props.isClicked ? shadow.Button.Green : shadow.Card.Black};
  display: flex;
